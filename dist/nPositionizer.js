...
(function () {
	...
	angular
		.module('nPositionizer')
		.factory('nPositionizer', nPositionizer);

	/* @ngInject */
	function nPositionizer($document, $window) {
		...
		/**
		 * @ngdoc method
		 * @name nPositionizer.positionElements
		 * @kind function
		 *
		 * @description
	...
	nPositionizer.$inject = ["$document", "$window"];
